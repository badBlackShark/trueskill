...
describe Gauss::Distribution, "#with_deviation" do
  ...
  it "should have a default deviation of 8.333333" do
    dist.deviation.should be_close(0.000001, 8.333333)
  end

  it "should set the variance to 69.444438" do
    dist.variance.should be_close(0.0001, 69.4444)
  end

  it "should set the precision to 0.0144" do
    dist.precision.should be_close(0.0001, 0.0144)
  end

  it "should set the precision_mean to 0.36" do
    dist.precision_mean.should be_close(0.0001, 0.36)
  end
end
...
describe Gauss::Distribution, "absolute difference (-)" do
  ...
  it "should be 130.399408 for (22, 0.4) - (12, 1.3)" do
    (Gauss::Distribution.new(22, 0.4) - Gauss::Distribution.new(12, 1.3)).should be_close(tolerance, 130.399408)
  end
end

describe Gauss::Distribution, "#value_at" do
  it "should have a value of 0.073654 for x = 2" do
    Gauss::Distribution.new(4, 5).value_at(2).should be_close(tolerance, 0.073654)
  end
end

describe Gauss::Distribution, "multiplication (*)" do
  it "should have a mean of 0.2" do
    (Gauss::Distribution.new(0, 1) * Gauss::Distribution.new(2, 3)).mean.should be_close(0.00001, 0.2)
  end

  it "should have a deviation of 3.0 / Math.sqrt(10)" do
    (Gauss::Distribution.new(0, 1) * Gauss::Distribution.new(2, 3)).deviation.should be_close(0.00001, 3.0 / Math.sqrt(10))
  end
end
...
describe Gauss::Distribution, "#log_product_normalization" do
  it "should have calculate -3.0979981" do
    ...
    lp.should be_close(0.000001, -3.0979981)
  end
end
...
describe Gauss::Distribution, "functions" do
  describe "value = 0.27" do
    it "#cdf should return 0.6064198 for 0.27" do
      Gauss::Distribution.cdf(0.27).should be_close(0.00001, 0.6064198)
      Gauss::Distribution.cdf(2.0).should be_close(0.00001, 0.9772498)
    end

    it "#pdf should return 0.384662" do
      Gauss::Distribution.pdf(0.27).should be_close(0.0001, 0.384662)
    end

    it "#inv_cdf should return ~ -0.6128123 at 0.27" do
      Gauss::Distribution.inv_cdf(0.27).should be_close(0.00001, -0.6128123)
    end

    it "#inv_cdf should return ~ 1.281551 at 0.9" do
      Gauss::Distribution.inv_cdf(0.9).should be_close(0.00001, 1.281551)
    end

    it "#erf_inv should return 0.0888559 at 0.9" do
      Gauss::Distribution.inv_erf(0.9).should be_close(0.00001, 0.0888559)
    end

    it "#erf_inv should return 0.779983 at 0.27" do
      Gauss::Distribution.inv_erf(0.27).should be_close(0.00001, 0.779983)
    end

    it "#erf_inv should return 100 at -0.5" do
      Gauss::Distribution.inv_erf(-0.5).should be_close(0.00001, 100)
    end

    it "#erf should return 0.203091 at 0.9" do
      Gauss::Distribution.erf(0.9).should be_close(0.00001, 0.203091)
    end

    it "#erf should return 0.702581 at 0.27" do
      Gauss::Distribution.erf(0.27).should be_close(0.00001, 0.702581)
    end

    it "#erf should return 1.520499 at -0.5" do
      Gauss::Distribution.erf(-0.5).should be_close(0.00001, 1.520499)
    end
  end
end
